...
const defaultMarkers: PulseMarker[] = [
  { id: "pulse-1", location: [51.51, -0.13],   delay: 0,   label: "ESOC" },
  { id: "pulse-2", location: [40.71, -74.01],  delay: 0.5, label: "New York" },
  { id: "pulse-3", location: [28.56, -80.57],  delay: 1,   label: "Cap Canaveral" },
  { id: "pulse-4", location: [5.25,  -52.77],  delay: 1.5, label: "Kourou (ESA)" },
  { id: "pulse-5", location: [-33.87, 151.21], delay: 2,   label: "Sydney" },
]
...
export function GlobePulse({
  ...
  // Sync de la vitesse sans recréer le globe
